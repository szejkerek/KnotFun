...
//     version 1.11.2
//     from Assets/DO NOT USE - Deprecated/Old PaperBlades/ScriptableObjects/Input/MovementSchemes.inputactions
//
...
public partial class @MovementSchemes: IInputActionCollection2, IDisposable
{
    ...
    ~@MovementSchemes()
    {
        UnityEngine.Debug.Assert(!m_Player3D.enabled, "This will cause a leak and performance issues, MovementSchemes.Player3D.Disable() has not been called.");
    }
